    ...
    [ns.Constants.DefaultThemeID] = {
        ...
        tokens = {
            color = {
                ...
                text = {
                    primary = Color(0.94, 0.96, 0.99),
                    secondary = Color(0.72, 0.77, 0.84),
                    muted = Color(0.51, 0.56, 0.64),
                    inverse = Color(0.07, 0.08, 0.11),
                },
                surface = {
                    canvas = Color(0.04, 0.05, 0.08, 1.00),
                    panel = Color(0.08, 0.09, 0.13, 0.96),
                    elevated = Color(0.11, 0.12, 0.17, 0.98),
                    inset = Color(0.05, 0.06, 0.09, 0.92),
                    overlay = Color(0.02, 0.03, 0.05, 0.88),
                },
                border = {
                    subtle = Color(0.20, 0.24, 0.32),
                    strong = Color(0.34, 0.40, 0.54),
